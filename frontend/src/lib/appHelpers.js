...
export function createEmptyCashSummary() { return { current_session: null, today_revenue: 0, cash_revenue: 0, non_cash_revenue: 0, today_profit: 0, today_sales_count: 0, today_units_sold: 0, expected_cash_now: 0, recent_sessions: [] }; }
